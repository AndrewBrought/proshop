...
const ThankYouScreen = ({ match, history }) => {
    ...
    useEffect(() => {
        ...
        //What we were told to change...trying to debug possibilities for Shelbs problem
    ...
    return loading ? <Loader /> : error ? <Message variant='danger'>{error}</Message> :
        <>
            <h1>Thank You For Your Order: {order._id}</h1>
            <h1>Inquired At: {order.paidAt.substring(0, 10)}</h1>
            {/*<Row>*/}
            {/*    <Col md={8}>*/}
            ...
            {/*            you the user will have to re-select payment... *!/*/}
            {/*            <ListGroup.Item>*/}
